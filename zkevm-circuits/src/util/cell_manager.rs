...
use crate::{evm_circuit::util::CachedRegion, util::query_expression};
...
impl CellColumn {
    ...
    pub fn new(advice: Column<Advice>, _cell_type: CellType, idx: usize) -> CellColumn {
        CellColumn { advice, idx }
    }
